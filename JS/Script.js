var nt = "img/notepad_plus_plus.png", bat = "img/Bat.png", cpp = "img/notepad_plus_plus.png", vs = "img/notepad_plus_plus.png",
js = "img/notepad_plus_plus.png", java = "img/notepad_plus_plus.png", as = "img/AndroidStodio.png",
csh = "img/notepad_plus_plus.png", py = "img/python.png", qt = "Qt.png", pas = "img/notepad_plus_plus.png";
var listProg = [
    ...
    ["Сартировка пузырьком", "2019", "Моя первая сортировка", "img/game5.png", cpp, vs],
    ...
    ["Тетрис", "2019", "Обычный класический тетрис", "img/game11.png", nt, bat],
    ["SpaceZombie", "2019", "Моя  первая игра на телефон", "img/game12.jpg", nt, bat],
    ["Кам-нож-бум мобайл", "2019", "Камень ножницы бумага на телефон", "img/game13.jpg", nt, bat],
